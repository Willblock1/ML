...
# initialize image path for prediction
img_path = f'/home/slalom/Desktop/image-classification/ungrouped_images'
...
for file in os.listdir(path = img_path):
	...
	cv2.imwrite(f'/home/slalom/Desktop/image-classification/predictions/{file}', output)
	#cv2.waitKey(0)
